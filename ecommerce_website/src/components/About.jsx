  ...
  return (
    <div className="about-container">
      ...
      <section className="about-content">
        ...
        <p className="about-text">
          Moreover, this is often not at once take the hardships of the life of harsh condemn, we are accusing him? Him whom something large cisterns.
        </p>
      </section>
    </div>
  );
